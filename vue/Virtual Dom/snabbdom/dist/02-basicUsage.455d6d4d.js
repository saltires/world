...
setTimeout(function () {
  vnode = (0, _snabbdom.h)("div", [(0, _snabbdom.h)('h1', 'Hello Snabbdom1'), (0, _snabbdom.h)('p', '这是一个标签1')]);
  patch(oldVNode, vnode); // 清空页面元素 -- 错误做法
  // patch(oldVNode, null)
  // 清空页面元素 -- 正确做法
...
//# sourceMappingURL=/02-basicUsage.455d6d4d.js.map